      ...
      <q-card v-for="series in timeline" :key="series" bordered style="min-height: 200px">
          <q-card-section class="col-8">
            ...
            <q-parallax src="../assets/module-6.jpg" :height="100" style="opacity: 0.8;">
              <q-label class="absolute-bottom text-h5 text-white text-weight-bolder q-ma-sm" style="text-shadow: 2px 2px black;">{{ series.series_title }}
            ...
            <q-card-section horizontal>
                ...
                <q-label class="col-2">Dan</q-label>
                <q-label class="col-2">Nick</q-label>
                <q-label class="col-2">{{ parseFloat(series.series_rating).toFixed(1) }}%</q-label>
            </q-card-section>
            <q-separator />
            <!-- BODY -->
            ...
            <div v-else>
              <q-card-section class="bg-grey-2" style="min-height:200px; min-width: 350px;">
                <q-card-section horizontal>
                  <q-label>No data available yet for "{{ series.series_title }}"</q-label>
                </q-card-section>
                <q-separator />
              </q-card-section>
            </div>
